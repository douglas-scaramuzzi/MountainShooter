    ...
    def run(self, ):
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    self.menu_text(text=MENU_OPTION[i], text_color=COLOR_YELLOW, text_size=20, text_center_pos=(WIN_WIDTH / 2, 200 + 25 * i))
                else:
                    self.menu_text(text=MENU_OPTION[i], text_color=COLOR_WHITE, text_size=20, text_center_pos=(WIN_WIDTH / 2, 200 + 25 * i))
            pygame.display.flip()
